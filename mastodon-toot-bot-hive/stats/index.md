...
<body>
<div id="rrgkavbbup" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
  <style>html {
...
#rrgkavbbup .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#rrgkavbbup .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#rrgkavbbup .gt_column_spanner_outer {
  color: #333333;
  background-color: #DeF7E9;
  font-size: 100%;
  font-weight: normal;
...
#rrgkavbbup .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#rrgkavbbup .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#rrgkavbbup .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#rrgkavbbup .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #B0E0E6;
  font-size: 100%;
...
#rrgkavbbup .gt_from_md > :first-child {
  margin-top: 0;
}

#rrgkavbbup .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#rrgkavbbup .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rrgkavbbup .gt_grand_summary_row {
  color: #333333;
  background-color: #B0E0E6;
  text-transform: inherit;
  padding-top: 8px;
...
#rrgkavbbup .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#rrgkavbbup .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#rrgkavbbup .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#rrgkavbbup .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#rrgkavbbup .gt_sourcenotes {
  color: #333333;
  background-color: #DeF7E9;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#rrgkavbbup .gt_font_normal {
  font-weight: normal;
}

#rrgkavbbup .gt_font_bold {
  font-weight: bold;
}

#rrgkavbbup .gt_font_italic {
  font-style: italic;
}
...
<td class="gt_row gt_right">3.7</td></tr>
  ...
  <tfoot class="gt_sourcenotes">
    <tr>
      <td class="gt_sourcenote" colspan="4">Total urls posted is 22079 of which 10859 are unique
