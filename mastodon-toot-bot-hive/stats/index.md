...
<body>
<div id="yyzugsbrib" style="overflow-x:auto;overflow-y:auto;width:auto;height:auto;">
  <style>html {
...
#yyzugsbrib .gt_bottom_border {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
}

#yyzugsbrib .gt_col_headings {
  border-top-style: solid;
  border-top-width: 2px;
...
#yyzugsbrib .gt_column_spanner_outer {
  color: #333333;
  background-color: #DeF7E9;
  font-size: 100%;
  font-weight: normal;
...
#yyzugsbrib .gt_column_spanner_outer:first-child {
  padding-left: 0;
}

#yyzugsbrib .gt_column_spanner_outer:last-child {
  padding-right: 0;
}

#yyzugsbrib .gt_column_spanner {
  border-bottom-style: solid;
  border-bottom-width: 2px;
  border-bottom-color: #D3D3D3;
  vertical-align: bottom;
...
#yyzugsbrib .gt_empty_group_heading {
  padding: 0.5px;
  color: #333333;
  background-color: #B0E0E6;
  font-size: 100%;
...
#yyzugsbrib .gt_from_md > :first-child {
  margin-top: 0;
}

#yyzugsbrib .gt_from_md > :last-child {
  margin-bottom: 0;
}
...
#yyzugsbrib .gt_first_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#yyzugsbrib .gt_grand_summary_row {
  color: #333333;
  background-color: #B0E0E6;
  text-transform: inherit;
  padding-top: 8px;
...
#yyzugsbrib .gt_first_grand_summary_row {
  padding-top: 8px;
  padding-bottom: 8px;
  padding-left: 5px;
  padding-right: 5px;
...
#yyzugsbrib .gt_striped {
  background-color: rgba(128, 128, 128, 0.05);
}

#yyzugsbrib .gt_table_body {
  border-top-style: solid;
  border-top-width: 2px;
  border-top-color: #D3D3D3;
  border-bottom-style: solid;
...
#yyzugsbrib .gt_footnote {
  margin: 0px;
  font-size: 90%;
  padding: 4px;
}

#yyzugsbrib .gt_sourcenotes {
  color: #333333;
  background-color: #DeF7E9;
  border-bottom-style: none;
  border-bottom-width: 2px;
...
#yyzugsbrib .gt_font_normal {
  font-weight: normal;
}

#yyzugsbrib .gt_font_bold {
  font-weight: bold;
}

#yyzugsbrib .gt_font_italic {
  font-style: italic;
}
...
<td class="gt_row gt_right">97034</td>
...
<td class="gt_row gt_right">4760</td>
...
<td class="gt_row gt_right">0.0</td></tr>
  ...
  <tfoot class="gt_sourcenotes">
    <tr>
      <td class="gt_sourcenote" colspan="4">Total urls posted is 130747 of which 39657 are unique
